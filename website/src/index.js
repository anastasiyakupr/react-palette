...
const GitHubLink = props => (
  <div style={{ marginTop: 20 }}>
    <a
      ...
      href="https://github.com/anastasiyakupr/react-palette"
      data-size="large"
      data-show-count="true"
      aria-label="Star anastasiyakupr/react-palette on GitHub"
    >
      Star
    </a>
  </div>
...
const Footer = props => (
  <footer style={{ marginTop: 5, bottom: 0 }}>
    ...
    >
      ...
      by{' '}
      <Link url="https://github.com/anastasiyakupr" style={{ fontSize: 18 }}>
